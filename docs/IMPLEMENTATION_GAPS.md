...
- Per-app VPN routing: Android include/exclude profiles are wired through TUN package filters and an installed-app picker. Missing import/export presets and Hiddify-style auto-selection.
