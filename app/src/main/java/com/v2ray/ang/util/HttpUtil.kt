...
object HttpUtil {
    ...
    fun getUrlContentWithUserAgent(request: UrlContentRequest): String {
        return getUrlContentAndHeaders(request).first
    }

    @Throws(IOException::class)
    fun getUrlContentAndHeaders(request: UrlContentRequest): Pair<String, Map<String, String>> {
