...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/PerQ4/byebox"
    const val APP_API_URL = "https://api.github.com/repos/PerQ4/byebox/releases"
    ...
    const val GEOIP_ONLY_CN_PRIVATE_DAT = "geoip.dat"
