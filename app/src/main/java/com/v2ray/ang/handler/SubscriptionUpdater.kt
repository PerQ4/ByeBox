...
object SubscriptionUpdater {
     ...
     */
    fun sync(
        context: Context = ByeBoxApplication.instance,
     ...
     */
    fun syncOne(context: Context = ByeBoxApplication.instance, subId: String) {
     ...
     */
    fun cancelOne(context: Context = ByeBoxApplication.instance, subId: String) {
